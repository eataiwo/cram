...
if __name__ == '__main__':
    ...
    rospy.loginfo(resp)
    # TODO: Make this into a node that publishes the fk into the relevant namespace
    # Then I can make a speed publisher node and a speed goal node the goal node will
    # use the PID on the scaling factors for velocity.